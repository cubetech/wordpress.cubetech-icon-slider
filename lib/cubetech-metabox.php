...
// Add the Meta Box
function add_cubetech_icon_slider_meta_box()
{
	add_meta_box(
		'cubetech_icon_slider_meta_box', // $id
		'Details des Inhaltes', // $title
		'show_cubetech_icon_slider_meta_box', // $callback
		'cubetech_icon_slider', // $page
		'normal', // $context
		'high'
	); // $priority
}
add_action('add_meta_boxes', 'add_cubetech_icon_slider_meta_box');

// Field Array
$prefix = 'cubetech_icon_slider_';
...
$cubetech_icon_slider_meta_fields = array(
	array(
		'label'=> 'Bildtitel',
...
// The Callback
function show_cubetech_icon_slider_meta_box()
{
	global $cubetech_icon_slider_meta_fields, $post;
// Use nonce for verification
	echo '<input type="hidden" name="cubetech_icon_slider_meta_box_nonce" value="'.wp_create_nonce(basename(__FILE__)).'" />';
	
	// Begin the field table and loop
	echo '<table class="form-table">';
	foreach ($cubetech_icon_slider_meta_fields as $field) {
...
// Save the Data
function save_cubetech_icon_slider_meta($post_id)
{
	global $cubetech_icon_slider_meta_fields;
	
	// verify nonce
	if (!wp_verify_nonce($_POST['cubetech_icon_slider_meta_box_nonce'], basename(__FILE__))) {
		return $post_id;
	}
	// check autosave
...
add_action('save_post', 'save_cubetech_icon_slider_meta');
